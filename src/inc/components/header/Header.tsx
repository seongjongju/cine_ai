...
const Header = ({isLoggedIn}: Users) => {
    ...
    return (
        <header 
            className='header'
            style={{
                backgroundColor: pathName.includes('discover_films_view') ? 'rgba(0,0,0,0)' : ''
            }}
        >
            <nav className='inner header__nav'>
                {
                    pathName.includes('discover_films_view') ? 
                    (
                        <h1>
                            <button
                                className='back-btn'
                ...
                {
                    pathName.includes('discover_films_view') ? null :
                    (
                        <>
                            <ul className='gnb'>
                                <button
                                    ...
                                    (
                                        <div className='user-service'>
                                            ...
                                            <Link
                                                ...
                                                href={'/wish?page=1'}
                                            >
                                                <span className='user-service__wish-quantity'>
                                                    {wishs.length}
                                                </span>
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#ffffff" className="size-6">
